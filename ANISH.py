#ANISH IS THE KING OF ALL CODERS
...
Author    : ANISH DON
Github    : [ ERROR ]
Facebook  : ANISH BARAL
Tool Name : ANISH-PRO
Tool Type : PAID
Version   : 3.0.0
----------------------------------------------
THIS IS PAID TOOL - PAY TO USE
ANISH XD THE FATHER OF ALL CODERS
\033[1;37m-------------------------------------------- """)
...
def chk():
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/dexterbruh/A-10/main/Approval.txt").text 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m YOUR ID IS NOT ACTIVE COPY👆 AND SEND ME MESSAGE ON FACEBOOK \033[0;91m#NOT FREE!!!") 

      os.system('xdg-open  https://www.facebook.com/anish.baralbrl.1?text=*Hello*%2C%20*Blessing*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*apk*%Full Updated*Updated*')
